...
py_forward(PyObject *self, PyObject *args)
{
	...
	PyObject *pScale = PyArray_ZEROS(1, scale_dims, NPY_DOUBLE, 0);
...
py_denomA(PyObject *self, PyObject *args)
{
	...
	if (!PyArg_ParseTuple(args, "O!", &PyArray_Type, &pGamma))
	{
		return NULL;
	}
...
py_xi(PyObject *self, PyObject *args)
{
	...
	PyObject *pXi = PyArray_ZEROS(3, xi_dims, NPY_DOUBLE, 0);

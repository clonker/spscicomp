...
class CommonSimpleDataImporter(CommonDataImporter):
    ...
    def has_more_data(self):
        """
        Return if there is any more data. As all data is returned when using get_data, this function always returns
        False.
...
class CommonBinaryFileDataImporter(CommonDataImporter):
    """
    Import data from a binary file. The file format should be as generated by :func:`numpy.save`.
    """
    def __init__(self, filename):
        """
        Initialize the class variables and initialize the file input stream.
